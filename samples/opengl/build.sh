...
konanc -target $TARGET $DIR/src/kotlin-native/OpenGlTeapot.kt -library $DIR/build/c_interop/opengl \
       -linkerArgs "$LINKER_ARGS" -o $DIR/build/bin/OpenGlTeapot || exit 1
